...
<h3><center><table border='1'><tr><th>Draft Messages</th><th>Draft Emails</th> <th>Delete</th></tr>
<c:forEach var="idto" items="${plist}">
<tr>

<td><center>${idto.getUdraft() }</center></td>
<td><center><a href="Composedraft?ibid=${idto.getInfid()}">${idto.getUinbox() }</a></center></td>
